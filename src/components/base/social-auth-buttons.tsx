 ...
 *
 * Render on every auth surface. Do NOT restyle or rebuild these inline.
 *
 * This project has ONLY Google configured on the Lovable broker, so callers pass
 * `providers={["google"]}` — see docs/design/auth.md.
 */
